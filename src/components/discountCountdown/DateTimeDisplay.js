...
const DateTimeDisplay = ({ value, type, isDanger }) => {
  ...
  return (
    <div
      ...
      className={` bg-gray-100  flex flex-col items-center mx-[2px] sm:mx-3 py-2 w-8 sm:w-10  backdrop-filter backdrop-blur-[8px] bg-palette-fill/50 shadow-lg rounded-lg ${
